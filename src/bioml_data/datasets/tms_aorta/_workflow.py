"""End-to-end workflow owned by the TMS Aorta product canary."""
...
def _preparation_protocol(
    ...
    return PreparationProtocol(
        protocol_id=TMS_AORTA_PREPARATION_PROTOCOL_ID,
        version=TMS_AORTA_PREPARATION_VERSION,
