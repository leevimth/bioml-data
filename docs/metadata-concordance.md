...
source-artifact SHA-256 and transform protocol; task and split protocol; and a
human-verifiable citation. This prevents a whole-atlas or primary-paper
...
The pinned TMS Aorta source audit records 906 cells, 22,966 features, six label
counts, and tissue `Aorta` for the exact FACS Aorta H5AD. These expectations are
...
assay evidence is `NOT_REPORTED`, rather than inferred from `method`.
